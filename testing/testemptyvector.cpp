...
/*                                                   +#+                      */
/*   Created: 2021/11/02 11:15:13 by tevan-de      #+#    #+#                 */
/*   Updated: 2021/11/02 17:47:17 by tevan-de      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
void	check_capacity_stats(std::vector<int>	v_empty)
{
...
int	main(void)
{
	...
	for (std::vector<int>::iterator it = v_empty.begin(); it != v_empty.end(); it++)
	{
		std::cout << *it << std::endl;
	}
	for (std::vector<int>::const_iterator it = v_empty.begin(); it != v_empty.end(); it++)
	{
		std::cout << *it << std::endl;
	}
	for (std::vector<int>::reverse_iterator it = v_empty.rbegin(); it != v_empty.rend(); it++)
	{
		std::cout << *it << std::endl;
	}
	for (std::vector<int>::const_reverse_iterator it = v_empty.rbegin(); it != v_empty.rend(); it++)
	{
		std::cout << *it << std::endl;
	}
	return (0);
